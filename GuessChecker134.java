...
public class GuessChecker134
{
  public static void main(String[] args)
  {
    ...
    if(r4==g4)
      hits++;
    if(g1==r1){nearHits++;}
    else if(g1==r2){nearHits++;}
    else if(g1==r3){nearHits++;}
    else if(g1==r4){nearHits++;}
    if(g2==r1){nearHits++;}
    else if(g2==r2){nearHits++;}
    else if(g2==r3){nearHits++;}
    else if(g2==r4){nearHits++;}
    if(g3==r1){nearHits++;}
    else if(g3==r2){nearHits++;}
    else if(g3==r3){nearHits++;}
    else if(g3==r4){nearHits++;}
    if(g4==r1){nearHits++;}
    else if(g4==r2){nearHits++;}
    else if(g4==r3){nearHits++;}
    else if(g4==r4){nearHits++;}
